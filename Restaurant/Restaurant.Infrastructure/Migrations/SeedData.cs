...
namespace Restaurant.Infrastructure.Migrations
{
    internal class SeedData
    {
        ...
        private static void AddMainDishWithAdditions(IDbConnection dbConnection)
        {
            ...
            dbConnection.Execute("INSERT INTO additions (Id, AdditionName, Price, ProductKind) VALUES (@Id, @AdditionName, @Price, @ProductKind)",
                        new { Id = Guid.NewGuid(), AdditionName = "Bar sałatkowy", Price = 5M, ProductKind = ProductKind.MainDish });
            dbConnection.Execute("INSERT INTO additions (Id, AdditionName, Price, ProductKind) VALUES (@Id, @AdditionName, @Price, @ProductKind)",
                        new { Id = Guid.NewGuid(), AdditionName = "Zestaw sosów", Price = 6M, ProductKind = ProductKind.MainDish });
        }
        ...
        private static void AddPizzaWithAdditions(IDbConnection dbConnection)
        {
            ...
            dbConnection.Execute("INSERT INTO additions (Id, AdditionName, Price, ProductKind) VALUES (@Id, @AdditionName, @Price, @ProductKind)",
                        new { Id = Guid.NewGuid(), AdditionName = "Podwójny ser", Price = 2M, ProductKind = ProductKind.Pizza });
            dbConnection.Execute("INSERT INTO additions (Id, AdditionName, Price, ProductKind) VALUES (@Id, @AdditionName, @Price, @ProductKind)",
                        new { Id = Guid.NewGuid(), AdditionName = "Salami", Price = 2M, ProductKind = ProductKind.Pizza });
            dbConnection.Execute("INSERT INTO additions (Id, AdditionName, Price, ProductKind) VALUES (@Id, @AdditionName, @Price, @ProductKind)",
                        new { Id = Guid.NewGuid(), AdditionName = "Szynka", Price = 2M, ProductKind = ProductKind.Pizza });
            dbConnection.Execute("INSERT INTO additions (Id, AdditionName, Price, ProductKind) VALUES (@Id, @AdditionName, @Price, @ProductKind)",
                        new { Id = Guid.NewGuid(), AdditionName = "Pieczarki", Price = 2M, ProductKind = ProductKind.Pizza });
        }
    }
}
